      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.text}>
            ...
            users to track and manage their expenses. It is provided by Jahbyte
            Technologies
          </Text>
        </View>
        <View style={styles.content}>
          ...
          <Text style={styles.text}>
            ...
            account by providing your email and password. You are responsible
            for maintaining the confidentiality of your login information and
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.text}>
            ...
            card information. User-provided data, such as email addresses and
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.text}>
            ...
            intellectual property of Jahbyte Technologies or its licensors.
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.text}>
            ...
            at all times. To the extent permitted by law, Expense Tracker will
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.text}>
            ...
            contact us at: support@jahbyte.com.
          </Text>
        </View>
      </View>
    </ScrollView>
